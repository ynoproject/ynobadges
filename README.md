...
Repository to host the badge files for the games present on [YNOproject](https://ynoproject.net).

User-submitted translations are welcomed on this repository.
